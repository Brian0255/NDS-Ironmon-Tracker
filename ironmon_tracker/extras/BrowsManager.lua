local function BrowsManager(settings, ui, frameCounters, program, screen)
    ...
    local browsOptions = {
        ...
        [196]={direction=1, brows={{x=0,y=10,file="Brows25RightFlat"},{x=-2,y=5,file="Brows25LeftTall"},}},
        ...
        [343]={direction=0, brows={{x=-2,y=6,file="Brows30RightFlat"},{x=-2,y=1,file="Brows30Left"},}},
        ...
        [412]={direction=0, brows={{x=7,y=3,file="Brows15Left"},{x=9,y=3,file="Brows15Right"},}},
        ...
        [415]={direction=0, brows={{x=3,y=1,file="Brows15"},{x=17,y=2,file="Brows15"},{x=8,y=15,file="Brows15"},}},
        ...
        [427]={direction=0, brows={{x=1,y=7,file="Brows15Left"},{x=-1,y=7,file="Brows25Right"},}},
        ...
        [431]={direction=1, brows={{x=-3,y=-2,file="Brows30Right"},}},
        [432]={direction=0, brows={{x=4,y=4,file="Brows25Left"},{x=7,y=4,file="Brows25Right"},}},
        [433]={direction=0, brows={{x=8,y=8,file="Brows15Left"},{x=9,y=12,file="Brows15Right"},}},
        ...
        [447]={direction=0, brows={{x=-1,y=1,file="Brows30RightTall"},{x=-1,y=1,file="Brows30LeftTall"},}},
        ...
        [471]={direction=0, brows={{x=4,y=9,file="Brows25Left"},{x=-3,y=8,file="Brows25RightFlat"},}},
        ...
        [535]={direction=1, brows={{x=0,y=1,file="Brows25Right"},{x=15,y=2,file="Brows25LeftTall"},}},
        [536]={direction=0, brows={{x=6,y=4,file="Brows25Left"},{x=5,y=5,file="Brows25Right"},}},
        [537]={direction=0, brows={{x=-7,y=6,file="Brows25RightFlat"},{x=17,y=7,file="Brows25LeftFlat"},}},
        ...
        [584]={direction=1, brows={{x=0,y=-1,file="Brows20Left"},{x=6,y=3,file="Brows20LeftFlat"},{x=19,y=6,file="Brows20Left"},}},
        ...
        [619]={direction=0, brows={{x=-6,y=10,file="Brows25RightFlat"},{x=1,y=10,file="Brows15Left"},}},
        ...
        [634]={direction=0, brows={{x=-6,y=4,file="Brows20Right"},{x=16,y=4,file="Brows20Left"},}},
