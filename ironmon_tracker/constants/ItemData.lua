...
ItemData.GEN_4_ITEMS =
    MiscUtils.readOnly(
    {
        ...
        [5] = {
            name = "Safari Ball",
            description = "Tries to catch a wild Pokemon in the Great Marsh or Safari Zone. Success rate is 1.5x."
        },
        [6] = {
            name = "Net Ball",
        ...
        [11] = {
            name = "Luxury Ball",
            description = "Tries to catch a wild Pokemon. Caught Pokemon start with 200 happiness."
        },
        [12] = {
            name = "Premier Ball",
            description = "Tries to catch a wild Pokemon."
        ...
        [14] = {
            name = "Heal Ball",
            description = "Tries to catch a wild Pokemon. Caught Pokemon are immediately healed."
        },
        [15] = {
            name = "Quick Ball",
        ...
        [44] = {
            name = "Sacred Ash",
            description = "Revives all fainted Pokemon with full HP."
        },
        [45] = {
            name = "Hp Up",
        ...
        [68] = {
            name = "Black Flute",
            description = "Halves the wild Pokemon encounter rate."
        },
        [69] = {
            name = "White Flute",
            description = "Doubles the wild Pokemon encounter rate."
        },
        [70] = {
            name = "Shoal Salt",
        ...
        [137] = {
            name = "Grass Mail",
            description = "Lets a Trainer write a message and send it via Pokemon trade."
        },
        [138] = {
            name = "Flame Mail",
            description = "Lets a Trainer write a message and send it via Pokemon trade."
        ...
        [159] = {
            name = "Figy Berry",
            description = "Consumed at 1/2 max HP to restore 1/8 max HP. Confuses Pokemon that dislike spicy flavor."
        },
        [160] = {
            name = "Wiki Berry",
            description = "Consumed at 1/2 max HP to restore 1/8 max HP. Confuses Pokemon that dislike dry flavor."
        },
        [161] = {
            name = "Mago Berry",
            description = "Consumed at 1/2 max HP to restore 1/8 max HP. Confuses Pokemon that dislike sweet flavor."
        },
        [162] = {
            name = "Aguav Berry",
            description = "Consumed at 1/2 max HP to restore 1/8 max HP. Confuses Pokemon that dislike bitter flavor."
        },
        [163] = {
            name = "Iapapa Berry",
            description = "Consumed at 1/2 max HP to restore 1/8 max HP. Confuses Pokemon that dislike sour flavor."
        },
        [164] = {
            name = "Razz Berry",
        ...
        [216] = {
            name = "Exp Share",
            description = "Half the experience from a battle is split between Pokemon holding this item."
        },
        [217] = {
            name = "Quick Claw",
        ...
        [280] = {
            name = "Destiny Knot",
            description = "Infatuates opposing Pokemon when holder is inflicted with infatuation."
        },
        [281] = {
            name = "Black Sludge",
        ...
        [288] = {
            name = "Sticky Barb",
            description = "Holder takes 1/8 (12.5%) its max HP at the end of each turn. When the holder is hit by a contact move, the attacking Pokemon takes 1/8 its max HP in damage and receive the item if not holding one."
        },
        [289] = {
            name = "Power Bracer",
        ...
        [435] = {
            name = "Fashion Case",
            description = "Holds Pokemon Accessories for use in Contests."
        },
        [436] = {
            name = "Seal Bag",
        ...
        [445] = {
            name = "Old Rod",
            description = "Used to catch Pokemon in bodies of water."
        },
        [446] = {
            name = "Good Rod",
            description = "Used to catch Pokemon in bodies of water."
        ...
        [457] = {
            name = "Contest Pass",
            description = "Allows participation in Pokemon Contests."
        },
        [458] = {
            name = "Magma Stone",
        ...
        [493] = {
            name = "Level Ball",
            description = "Success rate based off of fraction target Pokemon is of user's Pokemon. Made from Red Apricorn."
        },
        [498] = {
            name = "Moon Ball",
            description = "4x effectiveness on familes of Pokemon with a Moon Stone evolution. Made from Ylw Apricorn."
        },
        [495] = {
            name = "Heavy Ball",
        ...
        [492] = {
            name = "Fast Ball",
            description = "4x effectiveness on Pokemon with 100 or greater base speed. Made from Wht Apricorn."
        },
        [497] = {
            name = "Friend Ball",
            description = "Caught Pokemon start with 200 happiness. Made from Grn Apricorn."
        },
        [496] = {
            name = "Love Ball",
        ...
        [500] = {
            name = "Park Ball",
            description = "Catches Pokemon in the Pal Park every time."
        },
        [499] = {
            name = "Sport Ball",
            description = "Tries to catch a Pokemon in the Bug-Catching contest in National Park. "
        },
        [485] = {
            name = "Red Apricorn",
        ...
        [478] = {
            name = "Red Scale",
            description = "Trade to Mr. Pokemon for an Exp. Share."
        },
        [479] = {
            name = "Lost Item",
        ...
        [507] = {
            name = "Data Card-03",
            description = "Records the number of times the trainer's Pokemon have dashed in the Pokeathlon."
        },
        [508] = {
            name = "Data Card-04",
            description = "Records the number of times the trainer's Pokemon have jumped in the Pokeathlon."
        },
        [509] = {
            name = "Data Card-05",
        ...
        [516] = {
            name = "Data Card-12",
            description = "Records the number of times the trainer's Pokemon have messed up in the Pokeathlon."
        },
        [517] = {
            name = "Data Card-13",
            description = "Records the number of times the trainer's Pokemon have defeated themselves in the Pokeathlon."
        },
        [518] = {
            name = "Data Card-14",
            description = "Records the number of times the trainer's Pokemon have tackled in the Pokeathlon."
        },
        [519] = {
            name = "Data Card-15",
            description = "Records the number of times the trainer's Pokemon have fallen in the Pokeathlon."
        },
        [520] = {
            name = "Data Card-16",
        ...
        [527] = {
            name = "Data Card-23",
            description = "Records the number of times the trainer has switched Pokemon in the Pokeathlon."
        },
        [528] = {
            name = "Data Card-24",
        ...
        [529] = {
            name = "Data Card-25",
            description = "Records the number of times the trainer's Pokemon received prizes in the Pokeathlon."
        },
        [530] = {
            name = "Data Card-26",
            description = "Records the number of times the trainer has instructed Pokemon in the Pokeathlon."
        },
        [531] = {
            name = "Data Card-27",
...
ItemData.GEN_5_ITEMS =
    MiscUtils.readOnly(
    {
        ...
        [540] = {
            name = "Rocky Helmet",
            description = "When the holder is hit by a contact move, the attacking Pokemon takes 1/6 its max HP in damage."
        },
        [541] = {
            name = "Air Balloon",
        ...
        [547] = {
            name = "Eject Button",
            description = "When the holder takes damage from a move, it switches out for a party Pokemon of the Trainer's choice."
        },
        [548] = {
            name = "Fire Gem",
        ...
        [576] = {
            name = "Dream Ball",
            description = "Catches Pokemon found in the Dream World."
        },
        [577] = {
            name = "Poke Toy",
            description = "Ends a wild battle."
        ...
        [578] = {
            name = "Prop Case",
            description = "Stores props for the Pokemon Musical."
        },
        [579] = {
            name = "Dragon Skull",
        ...
        [612] = {
            name = "Item Drop",
            description = "Forces a friendly Pokemon to drop its held item."
        },
        [613] = {
            name = "Item Urge",
